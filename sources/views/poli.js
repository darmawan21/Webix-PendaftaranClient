...
export default class Poli extends JetView {
	config(){
		var ui = {rows: [
			{ view:"template", template:"Data Poli", type:"header" },
			{
				view:"toolbar", paddingY:2,
				cols:[
					{ view:"button", click:()=>this.tambahPoli(), label:"Tambah", type:"iconButton", width:100 },
					{ view:"button", click:()=>this.refreshPoli(), label:"Refresh", type:"iconButton", width:100 },
					{ template:"", borderless:true },
					{ view:"button", click:()=>this.ubahPoli(), label:"Ubah", type:"iconButton", width:100 },
					{ view:"button", click:()=>this.hapusPoli(), label:"Hapus", type:"iconButton", width:100 },
				]
			},
			{
				view:"datatable",
		...
		return {
			...
			head:{
				view:"toolbar", margin:-4, cols:[
					{ view:"label", label: "Tambah", id:"judulFormPoli" },
					{ view:"button", type:"iconButton", label:"Tutup", width:80, click:"$$('windowFormPoli').hide();"},
				]
			},
			body:{
				view:"form",
				...
				elements:[
					...
					{ cols: [
						{ template:"", borderless:true },
						{ view:"button", click:()=>this.simpanPoli(), label:"Simpan", width:120, borderless:true },
						{ template:"", borderless:true },
					]}
				]
			}
