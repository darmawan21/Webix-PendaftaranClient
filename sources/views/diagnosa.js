...
export default class Diagnosa extends JetView {
	config(){
		var ui = {rows: [
			{ view:"template", template:"Data Diagnosa", type:"header" },
			{
				view:"toolbar", paddingY:2,
				cols:[
					{ view:"button", click:()=>this.tambahDiagnosa(), label:"Tambah", type:"iconButton", width:100 },
					{ view:"button", click:()=>this.refreshDiagnosa(), label:"Refresh", type:"iconButton", width:100 },
					{ template:"", borderless:true },
					{ view:"button", click:()=>this.ubahDiagnosa(), label:"Ubah", type:"iconButton", width:100 },
					{ view:"button", click:()=>this.hapusDiagnosa(), label:"Hapus", type:"iconButton", width:100 },
				]
			},
			{
				view:"datatable",
		...
		return {
			...
			head:{
				view:"toolbar", margin:-4, cols:[
					{ view:"label", label: "Tambah", id:"judulFormDiagnosa" },
					{ view:"button", type:"iconButton", label:"Tutup", width:80, click:"$$('windowFormDiagnosa').hide();"},
				]
			},
			body:{
				view:"form",
				...
				elements:[
					...
					{ cols: [
						{ template:"", borderless:true },
						{ view:"button", click:()=>this.simpanDiagnosa(), label:"Simpan", width:120, borderless:true },
						{ template:"", borderless:true },
					]}
				]
			}
